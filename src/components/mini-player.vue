...
<template>
  <div class="mini-player" id="mini-player">
    ...
    <div class="mode">
      ...
      <!-- github -->
      <Icon :size="20" @click="goGitHub" class="mode-item" type="yonghu" />
    </div>
...
export default {
  ...
  methods: {
    ...
    goGitHub() {
      window.open("https://github.com/sylphcici/vue-netease-music-modified")
    },
  ...
  computed: {
    ...
    shareUrl() {
      return `${window.location.origin}/#/search/${this.currentSong.name}`
    },
    ...mapState([
      "currentSong",
      "currentTime",
